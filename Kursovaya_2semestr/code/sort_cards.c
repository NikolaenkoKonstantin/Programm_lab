...
void sort_names(head *q)
{
    if(q -> N > 1)
    {
        ...
        else if(strcmp(temp -> baza -> name, p1 -> baza -> name) < 0)
        {
            transfer_node(p1, temp, q);
            delete_node(temp -> prev, q);
        }
...
void sort_country(head *q)
{
    if(q -> N > 1)
    {
        ...
        if(k == 1)
            delete_node(temp -> prev, q);
        else if(strcmp(temp -> baza -> country, p1 -> baza -> country) < 0)
        {
            transfer_node(p1, temp, q);
            delete_node(temp -> prev, q);
        }
...
void sort_probability(head *q)
{
    if(q -> N > 1)
    {
        ...
        if(k == 1)
            delete_node(temp -> prev, q);
        else if(temp -> baza -> probability < p1 -> baza -> probability)
        {
            transfer_node(p1, temp, q);
            delete_node(temp -> prev, q);
        }
...
void sort_wins(head *q)
{
    if(q -> N > 1)
    {
        ...
        if(k == 1)
            delete_node(temp -> prev, q);
        else if(temp -> baza -> statistics[0] < p1 -> baza -> statistics[0])
        {
            transfer_node(p1, temp, q);
            delete_node(temp -> prev, q);
        }
...
void sort_draws(head *q)
{
    if(q -> N > 1)
    {
        ...
        if(k == 1)
            delete_node(temp -> prev, q);
        else if(temp -> baza -> statistics[1] < p1 -> baza -> statistics[1])
        {
            transfer_node(p1, temp, q);
            delete_node(temp -> prev, q);
        }
